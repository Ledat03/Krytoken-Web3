...
contract TokenSale {
    ...
    function buy() public payable {
        ...
        require(contributions[msg.sender] + amountToken < investorHardCap, "TokenSale: exceeds hard cap");
        require(token.balanceOf(address(this)) > amountToken, "TokenSale: exceeds hard cap");
