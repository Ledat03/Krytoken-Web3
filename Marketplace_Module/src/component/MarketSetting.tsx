            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border">
                  <th className="text-left py-3 px-4 text-sm font-semibold text-muted-foreground">Tên Token</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-muted-foreground">Ký hiệu</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-muted-foreground">Địa chỉ</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-muted-foreground">Trạng thái</th>
                  <th className="text-right py-3 px-4 text-sm font-semibold text-muted-foreground">Hành động</th>
                </tr>
              </thead>
              <tbody>
