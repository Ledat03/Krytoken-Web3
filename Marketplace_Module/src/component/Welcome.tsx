          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground" data-testid="text-footer-newsletter-desc">
                Get the latest news and updates from the Pudgy Penguins family.
              </p>
              <form className="flex gap-2">
                <Input type="email" placeholder="Enter your email" className="flex-1" data-testid="input-newsletter-email" />
                <Button variant="default" type="submit" data-testid="button-newsletter-submit"></Button>
              </form>
